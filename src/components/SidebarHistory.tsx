      ...
      {isSidebarOpen && (
        <div className="fixed inset-0 z-[100] flex pointer-events-auto">
          ...
          <motion.div 
            ...
            className="relative w-full max-w-[340px] bg-[#0d0d0e] h-full shadow-[0_0_50px_rgba(0,0,0,0.5)] flex flex-col border-r border-white/5 mr-auto"
          >
            {/* Header */}
                      ...
                      <div className="flex flex-col gap-1 min-w-0 flex-1">
                        ...
                        <div className="flex items-center gap-2">
                          <span className="text-[10px] font-medium text-[#8e918f] uppercase tracking-wider">
                            {new Date(chat.timestamp || Date.now()).toLocaleDateString('pt-BR', { month: 'short', day: 'numeric' })}
                          </span>
                          <span className="text-[10px] text-white/10">•</span>
                          <span className="text-[10px] font-medium text-[#8e918f] opacity-60">
                            {new Date(chat.timestamp || Date.now()).toLocaleTimeString('pt-BR', { hour: '2-digit', minute: '2-digit' })}
                          </span>
                        </div>
                      </div>
