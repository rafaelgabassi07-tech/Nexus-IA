      ...
      return (
        <div className="min-h-screen bg-[#0d0d0e] flex items-center justify-center p-6 font-sans">
          <div className="max-w-xl w-full">
            <div className="bg-white/[0.02] border border-red-500/20 rounded-[2.5rem] p-10 md:p-16 relative overflow-hidden shadow-2xl">
              ...
              <div className="relative z-10 flex flex-col items-center text-center space-y-8">
                ...
                <div className="space-y-4">
                  <h1 className="text-[32px] font-black text-white uppercase tracking-tighter italic leading-none">
                    Distorção na Matriz
                  </h1>
                  <p className="text-[14px] text-[#8e918f] font-medium leading-relaxed max-w-sm mx-auto opacity-80">
                ...
                <div className="flex flex-col sm:flex-row gap-4 w-full pt-4">
                   <Button 
                    ...
                    className="flex-1 h-14 bg-red-600 hover:bg-red-500 text-white rounded-2xl font-black uppercase text-[11px] tracking-[0.2em] shadow-xl shadow-red-600/20 transition-all active:scale-95"
                   >
            ...
            <p className="text-center mt-10 text-[10px] font-black uppercase tracking-[0.3em] text-[#4a4d51] animate-pulse">
